        ...
        <div class="col-12">
            ...
            <div class="form-group row mb-4">
                                                                <div class="col-xl-12 col-lg-12 col-sm-12">
                                                                    <center><b><p style="font-size:20px">Pilihlah Survey Penilaian Anda Tentang Pelayanan Sekolah !!!</p></center></b>                                                                
                                                                </div><br><br><br>
                                                                <div class="col-xl-4 col-lg-4 col-sm-4">
                                                                    <center><a href="{{ url('select_survey/3')}}"><img src="{{ asset('assets/core-admin/core-dist/img/puas.png') }}" style="width:50%"></a><br>
                                                                    Memuaskan
                                                                </div>
                                                                <div class="col-xl-4 col-lg-4 col-sm-4">
                                                                   <center><a href="{{ url('select_survey/2')}}"><img src="{{ asset('assets/core-admin/core-dist/img/cukup.png') }}" style="width:50%"></a><br>
                                                                    Cukup
                                                                </div>
                                                                <div class="col-xl-4 col-lg-4 col-sm-4">
                                                                    <center><a href="{{ url('select_survey/1')}}"><img src="{{ asset('assets/core-admin/core-dist/img/kurang.png') }}" style="width:50%"></a><br>
                                                                    Kurang</center>
                                                                </div>
                                                            </div>
            </div>
