...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.Crypt::encrypt($outgoing_mail->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			...
			<div class="box-body">
				...
				<div class="form-group @if ($errors->has('mail_number')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nomor Surat" name="mail_number" value="{{ $outgoing_mail->mail_number }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('about')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Perihal" name="about">{{ $outgoing_mail->about }}</textarea>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('file')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<a href="{{ asset('upload/file_surat_keluar/'.$outgoing_mail->file) }}" target="_blank">Lihat File</a>
							@endif
						</div>
					</div>
