				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('letter_date')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control datepicker" placeholder="Tanggal Surat" name="letter_date" value="{{ old('letter_date') }}">
							</div>
						</div>
                         </div>
					...
					<div class="form-group @if ($errors->has('mail_from')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Dari" name="mail_from" value="{{ old('mail_from') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('sender')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Pengirim" name="sender" value="{{ old('sender') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('entry_date')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control datepicker" placeholder="Tanggal Masuk" name="entry_date" value="{{ old('entry_date') }}">
							</div>
						</div>
                         </div>
					...
					<div class="form-group @if ($errors->has('destination')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tujuan" name="destination" value="{{ old('destination') }}" >
						</div>
					</div>
