				...
				<div class="form-group @if ($errors->has('mail_number')) has-error @endif">
					...
					<div class="form-group @if ($errors->has('mail_from')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Dari" name="mail_from" value="{{ $incoming_mail->mail_from }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('sender')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Pengirim" name="sender" value="{{ $incoming_mail->sender }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('destination')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tujuan" name="destination" value="{{ $incoming_mail->destination }}" >
						</div>
					</div>
